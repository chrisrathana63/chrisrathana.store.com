...
<head>
<meta charset="UTF-8">
  <title>chrisrathana.store|shop</title>
...
<meta name="description" content="Welcome to smliestore store!">
...
<!-- end home section -->
    <center><h1>ទំនិញមានលក់</h1>
    <p>សូមជ្រើសរើសទំនិញពីហាងរបស់យើង</p>

    <div class="products">
        <div class="product">
            <img src="images/Table1.png" alt="Product 1">
            <h3>ទំនិញ ១</h3>
            <p>$10.00</p>
        </div>
        <div class="product">
            <img src="images/Table1.png" alt="Product 2">
            <h3>ទំនិញ ២</h3>
            <p>$20.00</p>
        </div>
    </div>
  ...
  <h1>ទំនិញមានលក់</h1>
    ...
    <div class="products">
        <div class="product">
            <img src="images/penscrren.png" alt="Product 1">
            <h3>ទំនិញ ១</h3>
            <p>$10.00</p>
        </div>
        <div class="product">
            <img src="images/penscrren.png" alt="Product 2">
            <h3>ទំនិញ ២</h3>
            <p>$20.00</p>
        </div>
    </div>
    ...
    <div class="products">
        <div class="product">
            <img src="images/Table2.png" alt="Product 1">
            <h3>ទំនិញ ១</h3>
            <p>$10.00</p>
        </div>
        <div class="product">
            <img src="images/Table2.png" alt="Product 2">
            <h3>ទំនិញ ២</h3>
            <p>$20.00</p>
        </div>
    </div>
    ...
    <div class="products">
        <div class="product">
            <img src="images/Table3.png" alt="Product 1">
            <h3>ទំនិញ ១</h3>
            <p>$10.00</p>
        </div>
        <div class="product">
            <img src="images/Table3.png" alt="Product 2">
            <h3>ទំនិញ ២</h3>
            <p>$20.00</p>
        </div>
    </div>
    ...
    <div class="products">
        <div class="product">
            <img src="images/Table7.png" alt="Product 1">
            <h3>ទំនិញ ១</h3>
            <p>$10.00</p>
        </div>
        <div class="product">
            <img src="images/Table7.png" alt="Product 2">
            <h3>ទំនិញ ២</h3>
            <p>$20.00</p>
        </div>
    </div>
    ...
    <div class="products">
        <div class="product">
            <img src="images/Table6.png" alt="Product 1">
            <h3>ទំនិញ ១</h3>
            <p>$10.00</p>
        </div>
        <div class="product">
            <img src="images/Table6.png" alt="Product 2">
            <h3>ទំនិញ ២</h3>
            <p>$20.00</p>
        </div>
    </div>
...
<footer>
    <p>&copy; 2025 chrisrathana. រក្សាសិទ្ធិគ្រប់យ៉ាង។</p>
    <div class="social">
